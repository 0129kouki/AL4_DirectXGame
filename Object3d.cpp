...
void Object3d::LoadTexture()
{
	...
	result = LoadFromWICFile(wfilepath, WIC_FLAGS_NONE, &metadata, scratchlmg);
...
void Object3d::CreateModel()
{
	...
	const string filename = modelname + ".obj";//"triangle_mat";
	const string directoryPath = "Resoures/" + modelname + "/";  //"triangle_mat";
	...
	while (getline(file, line))
	{
		...
		if (key == "f")
		{
			...
			{
				//頂点インデックス1個分の文字列ストリームに変換して解析しやすくする
